...
public class ParticipantRestController {
    ...
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE)
    	public ResponseEntity<?> getId(@PathVariable("id") String login){
    	Participant participant = participantService.findByLogin(login);
	...
	public ResponseEntity<?> changePassword(@PathVariable("id") String login,
    ...
    return new ResponseEntity("Unable to change. A participant with login " + participant.getLogin() + " does not exist.", HttpStatus.CONFLICT);
	}
